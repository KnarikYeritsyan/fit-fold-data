                    ...
                    <div id="panelsStayOpen-collapse{{str_replace(' ', '', $cont)}}" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-heading{{str_replace(' ', '', $cont)}}">
                        <div class="accordion-body">
                            @foreach($content as $con=>$file)
                                ...
                                <a href="{!! route('cd-download',['method' => 'small-n','dir'=>$cont,'file'=>$file['name']]) !!}" title="Download data file">Download <i style="margin-left: 5px;" class="fa-solid fa-file-arrow-down"></i></a>
                                <br>
                            @endforeach
                        </div>
                    </div>
            ...
            if(e.detail.output_data_n['error_message']) {
                ...
                let data = [{
                    ...
                    header: {
                        values: [
                            ["<b>t<sub>0</sub></b> [K]"],
                            ["<b>h</b> [J/mol]"], ["<b>h<sub>ps</sub></b> [J/mol]"], ["<b>Q</b>"], ["<b>σ</b>"], ["<b>R<sup>2</sup></b>"]],
                        align: ["center"],
